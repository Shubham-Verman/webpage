...
window.onscroll = function() {
    ...
    if (window.scrollY > 10) {  // Change 50 to any scroll threshold
...
// JavaScript for Expanding and Collapsing Writings
const expandButtons = document.querySelectorAll('.expand-btn');

expandButtons.forEach(button => {
    button.addEventListener('click', function () {
        const fullContent = this.nextElementSibling; // Target the full-writing div
...
function showContent(subjectId) {
    ...
    let selectedSection = document.getElementById(subjectId);
